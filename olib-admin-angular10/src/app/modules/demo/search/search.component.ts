...
import { DatepickerConfig } from '../../common/configs/datepicker.config';

@Component({
  selector: 'olib-search',
  templateUrl: './search.component.html',
  styleUrls: ['./search.component.scss']
})
export class SearchComponent extends Admin {
  search: any;
  ...
  constructor(
    ...
    super(breadCrumbConfig,"DEMO","Search");
  }
  ...
  initialize() {
    ...
    this.kr =this.datepickerConfig.getLocale();
